...
## Target
- Type: web app | Electron app | CLI | API | generated artifact | other
- Launch or access: <URL, command, endpoint, artifact path, or setup command>
- Allowed fixtures and credential source: <fixtures plus approved secret-tool, browser profile, or exact environment-variable names; never values>
...
## Anti-Cheat Probes
- <Change fixture or input data and verify output changes accordingly.>
- <Refresh, retry, or reopen and verify expected persistence or reset behavior.>
- <Try invalid, empty, or boundary input and verify the promised handling.>
